  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('amd_audit')->notice('Created new deletion record %label', $logger_arguments);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The deletion record %label has been updated.', $message_arguments));
        $this->logger('amd_audit')->notice('Updated deletion record %label.', $logger_arguments);
        break;
    }
